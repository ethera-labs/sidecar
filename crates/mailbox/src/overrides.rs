...
// UniversalBridgeMailbox storage layout:
// authorizedBridges slot 0
// chainIDsInbox slot 1
// chainIDsOutbox slot 2
// inboxRootPerChain slot 3
// outboxRootPerChain slot 4
// inbox slot 5
// outbox slot 6
// createdKeys slot 7
